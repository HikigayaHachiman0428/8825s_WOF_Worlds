...
void innerElimination()
{
    ...
    rightWing.set(0);
    Kcor = 3;
    encoderDrive(80, 8, -290);
    delay(100);
    Kcor = 4;
    PIDDrift_new(-65, 35, -340);
    // encoderDrive(-70, -34, -292);
    PIDTurn(-352, 5);
    encoderDrive(-100, -70);
    timerDrive(-35, 500);
    timerDrive(30, 100);
    ...
    // delay(200);
    timerDrive(60, 200);
    PIDDrift_new(40, 60, -405);
    timerDrive(30, 300, -405);
    drive(-10, 100);
    delay(150);
    drive(10, -100);
    delay(150);
    ...
    rightFrontWing.set(1);
    timerDrive(60, 100);
    PIDDrift_new(50, 50, -450);
    timerDrive(70, 600);
    // timerDrive(-100, 200);
    closefrontRight;
    closefrontLeft;
    encoderDrive(-70, -45);
    PIDDrift_new(-35, 65, -360);
    leftWing.set(1);
    Kcor = 4;
    timerDrive(-60, 400, -360);
    drive(-30, -10);
    delay(200);
    drive(0);
    ////
